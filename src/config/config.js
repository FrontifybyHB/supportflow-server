...
const _config = {
    ...
    EMAIL_CONNECTION_TIMEOUT_MS: process.env.EMAIL_CONNECTION_TIMEOUT_MS,
    EMAIL_GREETING_TIMEOUT_MS: process.env.EMAIL_GREETING_TIMEOUT_MS,
    EMAIL_SOCKET_TIMEOUT_MS: process.env.EMAIL_SOCKET_TIMEOUT_MS,
    EMAIL_DNS_TIMEOUT_MS: process.env.EMAIL_DNS_TIMEOUT_MS,
    EMAIL_FORCE_IPV4: process.env.EMAIL_FORCE_IPV4,
    EMAIL_QUEUE_INIT_TIMEOUT_MS: process.env.EMAIL_QUEUE_INIT_TIMEOUT_MS,
    EMAIL_QUEUE_ADD_TIMEOUT_MS: process.env.EMAIL_QUEUE_ADD_TIMEOUT_MS,
